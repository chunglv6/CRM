...
def bootstrap_roll_back(){
    ...
    try {
        ...
        //Credential of user
       withCredentials([usernamePassword(credentialsId: '8cf687db-fdd1-450d-ab75-2aedbe5aec66', usernameVariable: 'username',
...
def isOpenMergeRequest(gitlabMergeRequestIid) {
    withCredentials([
        usernamePassword(credentialsId: '8cf687db-fdd1-450d-ab75-2aedbe5aec66', usernameVariable: 'username', passwordVariable: 'password'),
